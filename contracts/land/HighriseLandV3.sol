    ...
    IHighriseLandV3
{
    ...
    function initialize(
        ...
        __HighriseLandV3_init(name, symbol, baseTokenURI);
    }

    function __HighriseLandV3_init(
        string memory name,
        string memory symbol,
        string memory baseTokenURI
        ...
        __HighriseLandV3_init_unchained(name, symbol, baseTokenURI);
    }

    function __HighriseLandV3_init_unchained(
        string memory,
        string memory,
        string memory baseTokenURI
    ) internal onlyInitializing {
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        returns (bool)
    {
        return interfaceId == type(IHighriseLandV3).interfaceId || super.supportsInterface(interfaceId);
    }
    // -----------------------------------------------------------------------------------------------
